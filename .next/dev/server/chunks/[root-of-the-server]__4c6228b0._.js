...
"[project]/app/api/operations/transfer/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const response = await fetch(`http://invtrackapi.runasp.net/api/Transaction/GenerateTransfearAssetPDF?fromNationalId=${fromNationalId}&toNationalId=${toNationalId}&createdByUser=${createdByUser}`, {
            method: "POST",
            headers: {
                Accept: "*/*",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c6228b0._.js.map